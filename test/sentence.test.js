...
describe('The Sentence model...', () => {
    describe('has basic model information', () => {
        it('has text, type, and language', () => {
            const sentence = new Sentence({ text: 'This is a sentence.' });
    ...
    describe('detects types...', () => {
        it('can recognize a declarative sentence', () => {
            const sentence = new Sentence({ text: 'We give food to them.' });
        ...
        it('can recognize an interrobanged sentence', () => {
            ...
            const sentence2 = new Sentence({ text: 'We give food to them?!' });
            const sentence3 = new Sentence({ text: 'We give food to them‽' });
